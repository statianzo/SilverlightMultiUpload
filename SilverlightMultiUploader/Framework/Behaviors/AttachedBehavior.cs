...
namespace SilverlightMultiUploader.Framework.Behaviors
{
    /// <summary>
    ...
    public class AttachedBehavior
    {
        public static readonly DependencyProperty CommandParameterProperty =
            DependencyProperty.RegisterAttached("CommandParameter", typeof(object), typeof(AttachedBehavior), new PropertyMetadata(null));
